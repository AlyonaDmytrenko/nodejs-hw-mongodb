...
router.put('/:contactId', auth, validateBody(contactSchema), isValidId, ctrlWrapper(updateContact));
router.patch('/:contactId', auth, isValidId, validateBody(updateContactSchema), ctrlWrapper(patchContact));
